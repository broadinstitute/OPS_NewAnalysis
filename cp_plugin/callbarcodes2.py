...
CallBarcodes2
============
**CallBarcodes2** is used for assigning a barcode to an object based on the channel with the strongest intensity for a given number of cycles.
...
class CallBarcodes2(cellprofiler_core.module.Module):

    module_name = "CallBarcodes2"
    category = "Data Tools"
